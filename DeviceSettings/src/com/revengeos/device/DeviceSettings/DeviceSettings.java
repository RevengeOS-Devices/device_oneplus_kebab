...
import com.revengeos.device.DeviceSettings.FileUtils;
import com.revengeos.device.DeviceSettings.FPSInfoService;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
          if (preference == mFpsInfo) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    com.revengeos.device.DeviceSettings.HBMModeService.class);
            if (enabled) {
